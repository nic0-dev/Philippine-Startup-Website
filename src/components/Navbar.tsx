    ...
    <header className="sticky top-0 z-50 w-full border-b border-black/10 dark:border-white/10 bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <nav className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <ul className="hidden md:flex items-center gap-6 text-sm">
          ...
          <li><a className="hover:underline underline-offset-4" href="#cta">Pricing</a></li>
        </ul>
        <div className="flex items-center gap-3">
          <a href="#cta" className="rounded-full border border-black/10 dark:border-white/20 px-4 py-2 text-sm hover:bg-black/5 dark:hover:bg-white/10">Sign in</a>
          <a href="#cta" className="rounded-full bg-foreground text-background px-4 py-2 text-sm font-medium hover:opacity-90">Get started</a>
        </div>
      </nav>
    </header>
  );
